...
void rekomendasiLayananStreaming(int dana) {
    ...
    if (dana >= HARGA_NETFLIX + HARGA_DISNEY_PLUS + HARGA_HBO_GO) {
        ...
        cout << "Sisa dana: Rp. " << (dana - (HARGA_NETFLIX + HARGA_DISNEY_PLUS + HARGA_HBO_GO)) << endl;
    }


    if (dana >= HARGA_DISNEY_PLUS + HARGA_HBO_GO) {
        cout << "- Disney+ dan HBO GO\n";
        cout << "Sisa dana: Rp. " << (dana - (HARGA_DISNEY_PLUS + HARGA_HBO_GO)) << endl;
    }
    if (dana >= HARGA_NETFLIX + HARGA_DISNEY_PLUS) {
        cout << "- Netflix dan Disney+\n";
        cout << "Sisa dana: Rp. " << (dana - (HARGA_NETFLIX + HARGA_DISNEY_PLUS)) << endl;
    }
    if (dana >= HARGA_NETFLIX + HARGA_HBO_GO) {
        cout << "- Netflix dan HBO GO\n";
        cout << "Sisa dana: Rp. " << (dana - (HARGA_NETFLIX + HARGA_HBO_GO)) << endl;
    }
    ...
    if (dana < HARGA_NETFLIX + HARGA_HBO_GO) {  
        if (dana >= HARGA_DISNEY_PLUS) {
            cout << "- Disney+\n";
            cout << "Sisa dana: Rp. " << (dana - HARGA_DISNEY_PLUS) << endl;
        }
        if (dana >= HARGA_HBO_GO) {
            cout << "- HBO GO\n";
            cout << "Sisa dana: Rp. " << (dana - HARGA_HBO_GO) << endl;
        }
        if (dana >= HARGA_NETFLIX) {
            cout << "- Netflix\n";
            cout << "Sisa dana: Rp. " << (dana - HARGA_NETFLIX) << endl;
        }
    }
